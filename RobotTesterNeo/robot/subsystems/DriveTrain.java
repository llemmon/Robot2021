...
public class DriveTrain extends SubsystemBase {
  ...
  private static int counter = 9; // for limiting display
  private static int counter2 = 49;
  private static int counter3 = 49;
  ...
  public void doArcadeDrive(double speed, double rotation) {
    ...
    if (counter++ % 10 == 0) { System.out.println("**arcade driveTrain speed: " + speed +"  rotation: "+ rotation); }
    speed = speed * 0.75;
    // SquareInputs adjust inputs at low speeds so better control - note 1.0 * 1.0 is still 1
