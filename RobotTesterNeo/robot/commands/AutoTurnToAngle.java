...
public class AutoTurnToAngle extends CommandBase {
  ...
  public double getAngleError() {
      ...
      if (counter2++ % 5 == 0) {
      System.out.println("Turn Angle Error: "+String.format("%.3f", angleError)+"  yaw: "+String.format("%.3f", m_driveTrain.getHeadingAngle()));
    }
     return angleError;
  }
  ...
  public boolean isFinished() {
    if (counter++ % 10 == 0) { System.out.println("**AutoTurnToAngle isFinished() check - angle diff: "+String.format("%.3f", angleDifference)+" tolerance: "+DriveConstants.kToleranceDegrees); }
