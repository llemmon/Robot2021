...
public class AutoDriveStraightUnits extends CommandBase {
  ...
  public void initialize() {
    ...
    pid.reset();
    pid.setTolerance(2.0, 10.0);    // set tolerance for at setpoint check
  }
  ...
  public void execute() {
    ...
    if ( pidValue < kDeadbandRangeNeg ) {
      ...
      if (counter1 % 5 == 0) { System.out.println("**turn Right Correction: pid: "+String.format("%.3f", pidValue1)+" L/R: "+String.format("%.3f", leftSpeed)+"~"+String.format("%.3f", rightSpeed)); }
      ...
      if (counter2 % 5 == 0) { System.out.println("**turn left Correction: pid: "+String.format("%.3f", pidValue1)+" L/R: "+String.format("%.3f", leftSpeed)+"~"+String.format("%.3f", rightSpeed)); } 
    } else {
      leftSpeed = speed;
      rightSpeed = speed;
    }
